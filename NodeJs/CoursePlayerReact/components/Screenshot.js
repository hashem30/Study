...
class Screenshot extends Component {
  ...
  updateCanvas() {
    ...
    const ctx = this.refs.myss.getContext('2d');
    ctx.drawImage(this.refs.workingss, 0, 0);
  }

  render() {
    const { images } = this.props
    return (
      <canvas ref="workingss" style="display:none" width={500} height={300}></canvas>
      <canvas ref="myss" width="500" height="300" style="margin-top:10px"></canvas>
    )
  }
}
